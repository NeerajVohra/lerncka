...
### DaemonSet
```
create a manifest file with Kind Daemonset & use kubectl to create the object in k8s API Server.

kubectl create -f daemonset-ex1.yml --record      # create daemonset
kubectl apply -f daemonset-ex1.yml  --record      # update the daemonset 
...
### Jobs
```
create a manifest file with Kind Job & use kubectl to create the object in k8s API Server.
...
### Cron Jobs
```
create a manifest file with Kind CronJob & use kubectl to create the object in k8s API Server.
